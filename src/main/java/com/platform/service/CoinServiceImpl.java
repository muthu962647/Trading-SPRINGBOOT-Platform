...
import com.platform.repositry.CoinRespositry;
...
public class CoinServiceImpl implements CoinService{
    ...
    @Autowired
    private CoinRespositry coinRespositry;
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setSymbol(jsonNode.get("symol").asText());
    ...
    public Coin findById(String coinId) throws Exception {
        Optional<Coin> optionalCoin = coinRespositry.findById(coinId);
    ...
    public String getTop50CoinsByMarketCapRank() throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/markts/vs_currency=usd&per_page=50&page=1";
